...
public class WebDataSource implements DataSource {
    ...
    public String getKvalifikacniPrace(String rok, String katedra) {
        var uri = String.format("https://stag-demo.uhk.cz/ws/services/rest2/kvalifikacniprace/getKvalifikacniPrace?rokObhajoby=%s&outputFormat=JSON&katedra=%s", rok, katedra);
        return getFromUri(uri);
    }
